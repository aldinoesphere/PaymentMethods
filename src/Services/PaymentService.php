...
use PaymentMethods\Services\OrderService;
use PaymentMethods\Helper\PaymentHelper;
use PaymentMethods\Services\Database\SettingsService;
use PaymentMethods\Services\GatewayService;

/**
* Class PaymentService
* @package PaymentMethods\Services
*/
class PaymentService
{
	use Loggable;
	 ...
	 * @return array|null
	 */
	public function loadCurrentSettings($settingsType = 'paymentmethods_general')
	{
	...
	/**
	 * get the settings from the database for the given settings type is paymentmethods_general
	 *
	 * @return array|null
	 */
